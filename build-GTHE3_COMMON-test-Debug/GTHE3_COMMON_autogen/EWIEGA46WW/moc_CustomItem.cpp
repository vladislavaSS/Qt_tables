...
#include <memory>
#include "../../../GTHE3_COMMON/CustomItem.h"
...
QT_MOC_LITERAL(4, 36, 5) // "index"
    ...
    "CustomItem\0dataChanged\0\0QModelIndex\0"
    "index"
};
...
void CustomItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dataChanged((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomItem::*)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomItem::dataChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomItem::dataChanged(const QModelIndex & _t1)
{
